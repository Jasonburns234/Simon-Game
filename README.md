# Simon-Game
This code is an implementation of a simple Simon game, where the computer generates a sequence of colours, and the user needs to repeat the sequence by clicking the buttons in the correct order. The game progressively gets more challenging with each level. If the user makes a mistake, the game restarts from the beginning.
# Hi 👋 I am Jason Burns
## Developer
...
* 👨‍💻  I'm currently working on I'm currently working on A firebase mobile shopping App
